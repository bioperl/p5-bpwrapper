...
<a href="https://travis-ci.org/bioperl/p5-bprwrapper"><img src="https://travis-ci.org/bioperl/p5-bprwrapper.png"></a>
...
Here we provide Perl Module Bio::BPWrapper, command-line utilities and Perl Modules which wrap L<Bio::Perl>. See the L<Qiu Lab Bioutils wiki|http://diverge.hunter.cuny.edu/labwiki/Bioutils> for more detailed information.

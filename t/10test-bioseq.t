...
my $multi_opts = [
    ...
    ["--restrict EcoRI,AsuII", 'test-bioseq-re.fas',
     'mrestrict.right', 'multiple restriction cut'],
    ["--restrict-coord EcoRI", 'test-bioseq-re.fas',
     'restrict_coord.right', 'restriction coordinates'],

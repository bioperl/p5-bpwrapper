...
echo -ne "-d "; if ./biotree -d 'SV1' -d 'N40' test-files/test-biotree.dnd > /dev/null 2> /dev/null; then echo "works"; else echo "failed"; fi
...
echo -ne "-s "; if ./biotree -s 'SV1' -s 'B31' -s 'N40' test-files/test-biotree.dnd > /dev/null 2> /dev/null; then echo "works"; else echo "failed"; fi
echo -ne "-u "; if ./biotree -u test-files/test-biotree.dnd > /dev/null 2> /dev/null; then echo "works"; else echo "failed"; fi
echo -ne "-A "; if ./biotree -A 'SV1' -A 'B31' -A 'N40' test-files/test-biotree.dnd > /dev/null 2> /dev/null; then echo "works"; else echo "failed"; fi
...
echo -ne "-P "; if ./biotree -P 'N40' -P 'B31' -P 'SV1' test-files/test-biotree.dnd > /dev/null 2> /dev/null; then echo "works"; else echo "failed"; fi
